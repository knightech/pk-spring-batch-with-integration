...
public class BatchConfiguration {
    ...
    @Bean
    public ItemProcessor processor() { System.out.println("PROCESSOR"); return new PassThroughItemProcessor(); }

    @Bean
    public CustomItemWriter writer() { System.out.println("WRITER"); return new CustomItemWriter(); }

    @Bean
    @Qualifier("personJob")
    public Job personJob(Step step1) { System.out.println("JOB"); return jobBuilderFactory.get("personJob").incrementer(new RunIdIncrementer()).flow(step1).end().build(); }
